...
\point{Terminology:} 
\begin{itemize}
  \item If at least one of $I^{+}$ and $I^-$ is finite, we say the Lebesgue integral of $X$ exists,
  \item when both $I^{+}$ and $I^-$ are finite, we say $X$ is \emph{integrable}.
\end{itemize}
