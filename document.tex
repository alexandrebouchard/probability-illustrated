...
% then picture of many distributions converging

% then, heuristic

% then statement and plan of proof

% then generating functions

% then ch functions, proof
	% for exchange derivative and E, use Bernoulli counter-example

% then delta method, MAKE SURE TO GIVE IS exercise earlier, then assignment to analyze IS

% example for freq theory too
